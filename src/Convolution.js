...
class Convolution{
            ...
            /**
    *  To process the image - Resize,convolution and flatten a image. 
    * @param {string} directory  - The amount of neurons for each layer.
    * @param {number} img_length  - The activation function for each layer.
    * @param {number} img_height  - Accepts the JSON data type.
    * @param {number} kernel_size  - Accepts the JSON data type.
    * @param {number} conv_options  - Accepts the JSON data type.
    * @param {array} conv_kernel  - Accepts the JSON data type.
    *@returns {array} Image in array format.
    */
